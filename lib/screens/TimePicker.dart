...
import 'dart:async';
import '../controllers/wear_bridge.dart'; // 👈 Add this import
...
class _TimePickerScreenState extends State<TimePickerScreen> {
  ...
  void initState() {
    ...
    WearBridge.messages.listen((event) {
      ...
      if (event['type'] == 'message') {
        ...
        // You can react to message paths here if needed
      }
  ...
  void _confirmSelection() async {
    ...
    // 👇 Send this to phone via native channel
    try {
      await WearBridge.sendMessage(
        nodeId: 'dummy-node-id', // Replace this with actual node id logic
        path: '/alarm/set_time',
